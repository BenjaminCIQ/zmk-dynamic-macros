 ...
 *
 * dm_config — compile-time sizing for the pure core (redesign §2.1, ADR-0002).
 *
 ...
 * (the §4.1 decoupling proof). The values mirror the Kconfig defaults so host
 * tests exercise the same array shapes the firmware uses.
 *
